DROP PROCEDURE IF EXISTS minivelos.sp_DM_Patient_Enroll_Industrial;
CREATE PROCEDURE minivelos.`sp_DM_Patient_Enroll_Industrial`()
BEGIN
   /**************************************************************************************************************************\
  **  Purpose:    Combine study/patient information including PHI for reporting required Industrial enrollment criteria
  **  Issue:      Industrial Enrollment information will contain PHI and be DISTINCT based on included fields
  ...
  **  Exclusions: Only current Patient study status records
                  ...
                  Only include research type = 'Industrial' for Calendars
  **  Aliases:    dmsc=dm_study_current
                  dmp=dm_patient
  ** Last update date: 2020-Nov-10 (rename to sp_DM_Patient_Enroll_Industrial)
  \**************************************************************************************************************************/
...
WHERE
    ...
    AND dmsc.researchType_st_lu = 'Industrial'
;
 
TRUNCATE TABLE minivelos.dm_patient_enroll_industrial;
INSERT INTO minivelos.dm_patient_enroll_industrial
SELECT * from temp_DM_Patient_Industrial
;
