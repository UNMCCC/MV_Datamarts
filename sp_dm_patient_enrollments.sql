DROP PROCEDURE IF EXISTS minivelos.sp_DM_Patient_Enrollments;
CREATE PROCEDURE minivelos.`sp_DM_Patient_Enrollments`()
BEGIN
   /**************************************************************************************************************************\
  **  Purpose:    Combine study/patient information including PHI for reporting required enrollment criteria
  **  Issue:      Enrollment information will contain PHI and be DISTINCT based on included fields
...
DROP TEMPORARY TABLE IF EXISTS temp_DM_Patient_Enrollments;

CREATE TEMPORARY TABLE temp_DM_Patient_Enrollments
SELECT DISTINCT
  /* Study information */
  dmsc.pkStudy_st,
  dmsc.studyNumber_st,
...
TRUNCATE TABLE minivelos.dm_patient_enrollments;
INSERT INTO minivelos.dm_patient_enrollments
SELECT * from temp_dm_patient_enrollments
;
